  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "projects/:id/extras",
          component: () => import("../views/ProjectExtrasView.vue"),
        },
        {
        ...
        },
        {
          ...
          component: () => import("../views/TaskDependenciesView.vue"),
        },
        {
        ...
        },
        {
          ...
          component: () => import("../views/ProjectAttachmentView.vue"),
        },
...
router.beforeEach(async (to) => {
  ...
  if (!auth.user && localStorage.getItem("pmtool-token"))
    try {
      await auth.load();
    } catch {
      auth.logout();
  ...
  if (roles && !roles.includes(auth.user?.roleCode ?? "")) return "/dashboard";
  return true;
});
