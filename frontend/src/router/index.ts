...
const router=createRouter({history:createWebHistory(),routes:[
  ...
  {path:'/',component:()=>import('../layouts/MainLayout.vue'),children:[
    ...
    {path:'users',component:()=>import('../views/UserView.vue'),meta:{roles:['ADMIN']}}, {path:'organization',component:()=>import('../views/OrganizationView.vue'),meta:{roles:['ADMIN']}}, {path:'notifications',component:()=>import('../views/NotificationView.vue')}, {path:'profile',component:()=>import('../views/ProfileView.vue')}
