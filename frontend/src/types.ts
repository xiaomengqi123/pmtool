...
export interface Task { id:number; projectId:number; title:string; assigneeId:number; status:string; priority:string; estimatedHours:number; progress:number; sortOrder:number; version:number }
